...
describe('Facebook Verify Provider', () => {
  ...
  const signupProvider: FacebookSignUpFn = async (prof: FacebookStrategy.Profile) => null;
  ...
  const postVerifyProvider = async (prof: FacebookStrategy.Profile, usr: IAuthUser | null) => usr;
