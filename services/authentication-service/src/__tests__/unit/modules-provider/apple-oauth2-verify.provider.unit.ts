...
describe('Apple Verify Provider', () => {
  ...
  const signupProvider: AppleSignUpFn = async (prof: AppleStrategy.Profile) => null;
  ...
  const postVerifyProvider = async (prof: AppleStrategy.Profile, usr: IAuthUser | null) => usr;
