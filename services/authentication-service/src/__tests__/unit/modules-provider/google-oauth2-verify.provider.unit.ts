...
describe('Google Verify Provider', () => {
  ...
  const signupProvider: GoogleSignUpFn = async (prof: GoogleStrategy.Profile) => null;
  ...
  const postVerifyProvider = async (prof: GoogleStrategy.Profile, usr: IAuthUser | null) => usr;
