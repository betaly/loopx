...
import {InstagramOauth2VerifyProvider} from '../../../modules/auth/';
...
describe('Instagram Verify Provider', () => {
  ...
  const signupProvider: InstagramSignUpFn = async (prof: InstagramStrategy.Profile) => null;
  ...
  const postVerifyProvider = async (prof: InstagramStrategy.Profile, usr: IAuthUser | null) => usr;
