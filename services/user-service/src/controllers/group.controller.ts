...
export class GroupController {
  ...
  @authorize({
    permissions: [PermissionKey.CreateUserGroup, PermissionKey.CreateUserGroupNum],
  })
  @post(baseUrl, {
  ...
  @authorize({
    permissions: [PermissionKey.ViewUserGroupList, PermissionKey.ViewUserGroupList],
  })
  @get(`${baseUrl}/{id}`, {
    security: OPERATION_SECURITY_SPEC,
    responses: {
  ...
  @authorize({
    permissions: [PermissionKey.UpdateUserGroup, PermissionKey.UpdateUserGroupNum],
  })
  @patch(`${baseUrl}/{id}`, {
    security: OPERATION_SECURITY_SPEC,
    responses: {
  ...
  @authorize({
    permissions: [PermissionKey.DeleteUserGroup, PermissionKey.DeleteUserGroupNum],
  })
  @del(`${baseUrl}/{id}`, {
    security: OPERATION_SECURITY_SPEC,
    responses: {
